...
@property (weak, nonatomic)YYTextView*yz_textView;
@end
...
{
    UIImageView *imageview= note.object;
    ...
    NSMutableAttributedString *imageAttr=[NSMutableAttributedString yy_attachmentStringWithContent:imageview contentMode: UIViewContentModeScaleAspectFit attachmentSize:imageview.frame.size alignToFont:[UIFont systemFontOfSize:14] alignment:YYTextVerticalAlignmentCenter];
...
- (void)setTextView:(YYTextView*)textView
{
    _textView  = textView;
    if (!([textView isKindOfClass:[UITextField class]] || [textView isKindOfClass:[YYTextView class]])) {
