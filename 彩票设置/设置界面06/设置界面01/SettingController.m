...
- (void)setupGrup2{
    ...
    item5.operation = ^(NSIndexPath *indexpath){
        Test2Controller *test2vc=[[Test2Controller alloc]init];
        [weakself.navigationController pushViewController:test2vc animated:YES];
    };
    ...
    item8.operation = ^(NSIndexPath *indexpath){
        Test1Controller *test1vc=[[Test1Controller alloc]init];
       [weakself.navigationController pushViewController:test1vc animated:YES];
    };
