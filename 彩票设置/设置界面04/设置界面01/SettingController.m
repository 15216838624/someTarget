...
- (void)setupGrup0{
  NSMutableArray *array0 = [NSMutableArray array];
   Settingitem *item0 = [Settingitem itemWithIcon:[UIImage imageNamed:@"RedeemCode"] title:@"使用税换码"];
    item0.type= SettingsItemRightViewStateArrow;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (item.type==SettingsItemRightViewStateArrow) {
        cell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;
        
    } else if (item.type==SettingsItemRightViewStateSwitch) {
