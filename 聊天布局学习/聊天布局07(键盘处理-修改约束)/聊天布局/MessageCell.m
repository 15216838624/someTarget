...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if(self){
        ...
        //处理让文字在图片内
        _textButton.contentEdgeInsets=UIEdgeInsetsMake(10, 10, 10, 10);
        ...
        if ([reuseIdentifier isEqualToString:@"me"]) {
            ...
            [_textButton setBackgroundImage:[UIImage imageNamed:@"chat_send_press_pic"] forState:UIControlStateNormal];
            ...
            //图片拉伸变形处理
            [_textButton setBackgroundImage:[UIImage imageNamed:@"chat_recive_nor"] forState:UIControlStateNormal];
        }
